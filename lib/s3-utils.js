...
/**
 * make the PG dump object on AWS public: needs to be done after each upload
 * @return {Promise} fulfils with result of permissions change
 */
...
/**
 * upload the latest dump from the `destPath` to AWS
 * @return {Promise} fulfils with result of upload
 */
function upload() {
